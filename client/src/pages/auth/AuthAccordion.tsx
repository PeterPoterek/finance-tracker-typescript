  ...
  return (
    <Accordion type="single" collapsible className="w-full h-[653px] ">
      <AccordionItem value="item-1">
        ...
        <AccordionContent>
          <p>
            ...
            effortlessly categorize expenses, provide detailed descriptions, and
            specify the amount spent.
          </p>
          <p>
            Furthermore, users gain insights into their spending habits through
            comprehensive reports and visualizations accessible in the profile
            tab.
          </p>
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-2">
        ...
        <AccordionContent>
          <p>Users can register, log in, and manage their accounts securely.</p>
          <p>
      ...
      <AccordionItem value="item-3">
        ...
        <AccordionContent>
          <p>
            ...
            <a target="_blank" href="https://react.dev/" className="font-bold">
              React
            </a>
            , utilizing{" "}
            <a
